...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => e is { Job: "Frontend programmer", Salary: > 1000 }).OrderByDescending(e => e.Ename);
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => e.Salary == Emps.Max(em => em.Salary));
            return result;
        }
